...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	for (int i = 0; i < (row_1 / 8); i++)
	{
		MPI_Send(&(proc4_res[i][0]), column_2, MPI_LONG_DOUBLE, 5, tagA4, MPI_COMM_WORLD);
		MPI_Send(&(proc2_res[i][0]), column_2, MPI_LONG_DOUBLE, 5, tagA2, MPI_COMM_WORLD);
	}
	cout << "Send proc2_res, proc4_res, from processor with rank 2 to processor with rank 5" << endl;
}