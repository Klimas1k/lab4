...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	for (int i = 0; i < row_1 / 8; i++)
	{
		MPI_Recv(&(proc4_res[i][0]), column_2, MPI_LONG_DOUBLE, 6, tagA4, MPI_COMM_WORLD, &status);
		MPI_Recv(&(proc2_res[i][0]), column_2, MPI_LONG_DOUBLE, 6, tagA2, MPI_COMM_WORLD, &status);
		MPI_Recv(&(proc7_res[i][0]), column_2, MPI_LONG_DOUBLE, 6, tagA7, MPI_COMM_WORLD, &status);
		MPI_Recv(&(proc3_res[i][0]), column_2, MPI_LONG_DOUBLE, 6, tagA3, MPI_COMM_WORLD, &status);
	}
	...
	cout << "Send proc1_res, proc2_res, proc3_res, proc4_res, pro6_res, proc7_res from processor with rank 1 to processor with rank 0" << endl;
}