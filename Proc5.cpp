...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	for (int i = 0; i < row_1 / 8; i++)
	{
		...
		MPI_Recv(&(proc1_res[i][0]), column_2, MPI_LONG_DOUBLE, 2, tagA1, MPI_COMM_WORLD, &status);
	...
	for (int i = 0; i < (row_1 / 8); i++)
	{
		...
		MPI_Send(&(proc2_res[i][0]), column_2, MPI_LONG_DOUBLE, 3, tagA2, MPI_COMM_WORLD);
		MPI_Send(&(proc7_res[i][0]), column_2, MPI_LONG_DOUBLE, 3, tagA7, MPI_COMM_WORLD);
		MPI_Send(&(proc3_res[i][0]), column_2, MPI_LONG_DOUBLE, 3, tagA3, MPI_COMM_WORLD);
		MPI_Send(&(proc1_res[i][0]), column_2, MPI_LONG_DOUBLE, 3, tagA1, MPI_COMM_WORLD);
	...
	cout << "Send proc5_res from processor with rank 5 to processor with rank 3" << endl;
